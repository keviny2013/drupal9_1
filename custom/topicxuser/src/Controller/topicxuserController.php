...
namespace Drupal\topicxuser\Controller;
 ...
 */
class topicxuserController extends ControllerBase {
  ...
  public function content(Request $request) {
    ...
    $result = $connection->insert('topicxuser')
      ->fields([
  ...
  public function approve(Request $request) {
    ...
    $result = $connection->update('topicxuser')
      ->fields([
        'status' => 1,
      ])
    ...
    elseif ($node->bundle() == 'topicxuser1') {
      $user = User::load($request->get('userid'));
      $user->addRole('topicxuser_editor');
      $user->save();
    }
